...
p1 <- ggplot(singleTrail, aes(yday, max.camera)) +
  ...
  labs(
    y = "Camera Count ",
    x = "Date", 
    title = "Traffic by Day of Year",
    subtitle = "2021" ) +
  theme(text = element_text(size=18))

singleTrail$wday2 <- lubridate::wday(singleTrail$date, label = T)

p2 <- ggplot(singleTrail, aes(wday2, max.camera)) +
  geom_point()+
    guides(fill = 'none') +
  # ylim(0, 1000) +
  labs(
...
p4 <- ggplot(singleTrail, aes(precipitation_in, max.camera)) +
  ...
  labs(
    y = "Camera Count",
    x = "Precipitation (in)", 
    title = "Traffic versus Precipitation",
    subtitle = "2021" ) +
  theme(text = element_text(size=18))
...
p6 <- ggplot(singleTrail, aes(daily_aqi_value, max.camera)) +
  ...
  labs(
    y = "Camera Count",
    x = "Daily Air Quality Index", 
    title = "Traffic vs AQI",
    subtitle = "2021" ) +
  theme(text = element_text(size=18))
...
p7 <-  ggplot(singleTrail, aes(max.count, max.camera)) +
  ...
  labs(
    y = "Camera Count",
    x = "Strava Trip Count", 
    title = "Traffic vs Strava Trail Use",
    subtitle = "2021" ) +
  theme(text = element_text(size=18))
...
p8 <- ggplot(singleTrail, aes(num_views,
  ...
  labs(
    y = "Camera Count",
    x = "AllTrails Daily Searchs (# of Views)", 
    title = "Traffic vs AllTrails Search Frequency",
    subtitle = "2021" ) +
  theme(text = element_text(size=18))
...
plot2 <- ggpubr::annotate_figure(plot, 
                        top = ggpubr::text_grob("Middle Cottonwood Trail Traffic", 
                size = 18))

ggsave(
  filename = here::here("output/figures/MiddleCottonwood_Covariates.png"),
  plot = plot2, 
  height = 9.5, 
  width = 13,
  dpi = 700)
...
knitr::include_graphics(here::here("output/figures/MiddleCottonwood_Covariates.png"))
