...
## An analysis of the change in predictive accuracy as the number of trail counters used changes.
...
```{r GI-globaldeviations1, eval = T, fig.height = 13, fig.width= 10, fig.align='center', out.width="100%", fig.cap="Functional relationships for the trail use data estimated for model GI. s(yday): the global smoothers; subsectionF: trail-specific random effect intercepts. The remaining plots are the trail-specific smoothers, indicating how the functional response of that trail differs from the global smoother."}
load(file=here("output/models/allT_subsection_gamm_GI.rda"))
  
  gratia::draw(gamm_modGI, select = c(1:12), ncol = 3)
  # gratia::draw(gamm_modGI, select = c(13:24), ncol = 3)
    # gratia::draw(gamm_modGI, select = c(25:29), ncol = 3)
...
```{r GI-globaldeviations2, eval = T, fig.height = 13, fig.width= 10, fig.align='center', out.width="100%", fig.cap="Functional relationships for the trail use data estimated for model GI. s(yday): the global smoothers; subsectionF: trail-specific random effect intercepts. The remaining plots are the trail-specific smoothers, indicating how the functional response of that trail differs from the global smoother."}
# load(file=here("output/models/allT_subsection_gamm_GI.rda"))
...
```{r GI-globaldeviations3, eval = T, fig.height = 13, fig.width= 10, fig.align='center', out.width="100%", fig.cap="Functional relationships for the trail use data estimated for model GI. s(yday): the global smoothers; subsectionF: trail-specific random effect intercepts. The remaining plots are the trail-specific smoothers, indicating how the functional response of that trail differs from the global smoother."}
# load(file=here("output/models/allT_subsection_gamm_GI.rda"))
