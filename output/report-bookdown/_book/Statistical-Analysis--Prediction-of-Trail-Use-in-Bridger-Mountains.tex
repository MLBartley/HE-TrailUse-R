...
\hypersetup{
  pdftitle={Statistical Analysis: Predicting Trail Use in the Bridger Mountains},
...
{\centering \includegraphics[width=1\linewidth]{Statistical-Analysis--Prediction-of-Trail-Use-in-Bridger-Mountains_files/figure-latex/GI-globaldeviations1-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistical-Analysis--Prediction-of-Trail-Use-in-Bridger-Mountains_files/figure-latex/GI-globaldeviations2-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistical-Analysis--Prediction-of-Trail-Use-in-Bridger-Mountains_files/figure-latex/GI-globaldeviations3-1} 
