...
```{r}
ggplot(singleTrail, aes(yday, max.camera)) +
  geom_point()

ggplot(singleTrail, aes(wday, max.camera)) +
  geom_point()

ggplot(singleTrail, aes(week, max.camera)) +
  geom_point()

ggplot(singleTrail, aes(precipitation_in, max.camera)) +
  geom_point()

ggplot(singleTrail, aes(temp_min_f, max.camera)) +
  geom_point()

ggplot(singleTrail, aes(temp_max_f, max.camera)) +
  geom_point()

ggplot(singleTrail, aes(daily_aqi_value, max.camera)) +
  geom_point()
...
```{r gam, eval = T, echo = T}
gam_mod <- gam(max.camera ~ max.count + 
                 s(yday, bs = "cc") + 
                 s(wday, bs = "cc",  k = 7) +
...
gam_mod2 <- gam(max.camera ~  s(yday, bs = "cc") +
                      s(month, k = 3) +
                      s(wday,
                        bs = "cc", k = 7) +
                      s(daily_aqi_value) +
