...
# load strava data
strava_day <- readxl::read_excel("data/raw/strava_day.xlsx")
strava_month <- readxl::read_excel("data/raw/strava_month.xlsx")
strava_year <- readxl::read_excel("data/raw/strava_year.xlsx")

#load trail data
trail_char <- readxl::read_excel("data/raw/trailcharacteristics.xlsx")
trail_count <- readxl::read_excel("data/raw/trailcounterdata.xlsx")

#load relational data table joining strava and trail count IDs - multiple sheets
join_IDs <- readxl::read_excel("data/raw/Trailhead_Strava_Crosswalk.xlsx", sheet = 1)
join_IDs_allEdges <- readxl::read_excel("data/raw/Trailhead_Strava_Crosswalk.xlsx", 
                                            sheet = 3)

#load weather data
weather <- readxl::read_excel("data/raw/weather_airquality.xlsx")
...
trail_count$DayOfWeek <- lubridate::wday(trail_count$date, label=T)
